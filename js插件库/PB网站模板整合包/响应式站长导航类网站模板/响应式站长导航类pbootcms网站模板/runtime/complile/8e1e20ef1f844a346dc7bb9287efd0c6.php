...
<body>
    ...
    <div class="container">
        ...
        <div class="part">
            <div class="items">
                <div class="row">
                    {pboot:list num=20 order=sorting}
                    <div class="col-xs-6 col-sm-4 col-md-3">
                        <div class="item"> <a class="link" target="_blank" href="http://[list:ext_wangzhi]" rel="nofollow"><i class="autoleft fa fa-angle-right" title="[list:title]"></i></a> <a class="a" href="[list:link]" title="[list:title]" target="_blank"> <img src="[list:ico]" alt="[list:title]" title="[list:title]">
                                <h3>[list:title]</h3>

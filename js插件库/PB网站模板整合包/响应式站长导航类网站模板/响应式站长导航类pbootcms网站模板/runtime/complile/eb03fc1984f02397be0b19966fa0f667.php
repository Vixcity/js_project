...
<body>
    ...
    <div id="mask"></div>
    <div class="breadnav">
        <div class="container bread"> <i class="fa fa-home"></i>搜索 {pboot:keyword} 的结果 </div>
    </div>
    <div class="container">
        <!-- 广告位AD4  -->
        <div class="part">
            <div class="items">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3">
                        <div class="item"> <a class="link" target="_blank" href="http://[list:ext_wangzhi]" rel="nofollow"><i class="autoleft fa fa-angle-right" title="[search:title]"></i></a> <a class="a" href="[search:link]" title="[search:title]" target="_blank"> <img src="[search:ico]" alt="[search:title]" title="[search:title]">
                                <h3>[search:title]</h3>
